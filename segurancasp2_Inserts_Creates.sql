...
/* INSERT das 5 Zonas, atribuindo IDs automáticos */
...
/* Normalização e inserção de nomes de bairros na tabela Bairro,
 * alteração da estrutura da tabela para adicionar colunas e criar uma 
 * FK para associar cada bairro a uma região */
insert into bairro
...
/* Inserção de dados em LOGRADOURO */
...
/* Inserção de dados em DELEGACIA */
...
/* Inserção de dados em LOCALIDADE */
